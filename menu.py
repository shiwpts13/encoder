...
|  __/ | | | (_| (_) | (_| |  __/ |
 ...
 version:1.1
		...
		if inp == 1:
			from modules.modulespersian import compilep, decompilep
			while True:
				try:
					os.system('clear')
					time.sleep(0.1)
...
|  __/ | | | (_| (_) | (_| |  __/ |
 ...
 version:1.1
		""")
			...
			from modules.modulesenglish import compile, decompile
			while True:
				try:    
					os.system('clear')
					time.sleep(0.1)
...
|  __/ | | | (_| (_) | (_| |  __/ |
 ...
 version:1.1
		""")
			...
			from modules.modulesarabic import compilea, decompilea
			while True:
				try:    
					os.system('clear')
					time.sleep(0.1)
